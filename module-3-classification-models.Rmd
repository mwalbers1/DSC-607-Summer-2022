...
```{r}
#medal_types <- medals_knn_train$medal_type
```


```{r}
#p <- knn(train = medals_knn_train[-1], test = medals_knn_test[-1], cl = medal_types, k=3)
```

```{r}
# Create a confusion matrix of the predicted versus actual values
#actual_medals <- medals_knn_test$medal_type
#table(actual_medals, p)

```

```{r}
# Compute the accuracy
#mean(p == actual_medals)
```
